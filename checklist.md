...
| Cloud de referencia (Azure, no obligatorio) | `✅` | Vercel como cloud principal; `Dockerfile` multi-stage y guía de Azure Container Apps/App Service documentada | — |
...
| Observabilidad (logs/telemetría) | `✅` | `x-request-id`, logs HTTP/errores con `requestId` y `exposedHeaders` para trazabilidad | Agregar Sentry para trazabilidad remota |
