...
export class PaginatedResponseDto {
  ...
  @ApiProperty({ description: 'Listado de registros. La forma de cada ítem depende del endpoint.', example: [], isArray: true })
  data!: unknown[];

  @ApiProperty({ description: 'Metadatos de paginación por cursor', type: () => PaginationMetaDto })
